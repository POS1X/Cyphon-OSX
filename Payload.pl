...
Cyphon - the lowbandwith, poisonous HTTP client originated from Slowloris. Payload edited, compiled and wrapped
by @pos1x (Abilash). http://cyphon.tumblr.com / twitter - @pos1x for updates.
...
if ( $Config{usethreads} ) {
    ...
    print "Cyphon will be slower than normal as a result.\n";
}
